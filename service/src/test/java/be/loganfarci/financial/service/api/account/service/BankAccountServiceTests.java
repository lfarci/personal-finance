...
import static be.loganfarci.financial.service.api.account.service.BankAccountService.REQUIRED_BANK_ACCOUNT_ERROR;
import static be.loganfarci.financial.service.api.account.service.BankAccountService.REQUIRED_BANK_ACCOUNT_OWNER_ERROR;
...
public class BankAccountServiceTests {
    ...
    public void shouldThrowBankAccountIsInvalidExceptionWhenSavingInvalidAccount() {
        ...
        doThrow(InvalidBankAccountException.class).when(bankAccountValidator).requireValid(bankAccount);
        assertErrorFor(bankAccount, InvalidBankAccountException.class);
    }
